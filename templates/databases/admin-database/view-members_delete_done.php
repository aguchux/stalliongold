...
$sqli = "DELETE FROM members WHERE user_id='$user_id'";
	...
	<div class="database_container">
		<div class="database_sidebar" id="myToggle">
			<nav class="nav_database">
				<ul>
					<li><a href="admin_/admin_database/database" class="current">HOME</a></li>
		...
		<div class="database_content">
			...
			<div id="top_others_content_second">
				...
				<div>
					<p>PROFILE OF CLIENT DELETED SUCCESSFULLY.</p>
				</div>
