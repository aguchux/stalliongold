		...
		<div class="database_content">
			...
			<div id="top_others_content_second">
				...
				<div class="profile_form">
					<form action="admin_view_partners_delete_done.php" method="POST" name="RegisterForm" id="RegisterForm" enctype="multipart/form-data">
						<label>MERGE PARTNER ID:</label>
						<input name="merge_id" type="text" id="merge_id" placeholder="merge partner id" required />
						<br>
						<br>
				...
				<div class="edit_kong">
					<a href="/admin_database/view_partners"><div style="text-align:center;" id="transactBar">GO BACK</div></a>
				</div>
