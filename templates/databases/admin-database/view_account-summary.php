	...
	<div class="database_container">
		...
		<div class="database_content">
			...
			<div id="top_others_content_second">
				...
				<div class="edit_kong">
					<a href="admin_database.php"><div style="float:left; margin-right:50px;" id="transactBar">GO BACK</div></a>
					<a href="admin_view_account_summary_addnew.php"><div style="float:left; margin-right:50px;" id="transactBar">ADD</div></a>
					<a href="admin_view_account_summary_edit.php"><div style="float:left; margin-right:50px;" id="transactBar">EDIT</div></a>
					<a href="admin_view_account_summary_delete.php"><div style="float:left;" id="transactBar">DELETE</div></a>
				</div>
			</div>
