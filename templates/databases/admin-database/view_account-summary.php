	...
	<div class="database_container">
		...
		<div class="database_content">
			...
			<div id="top_others_content_second">
				<div class="boxOne">
					<p>ACCOUNT SUMMARY OF CLIENTS</p>
				</div>
				...
				<div class="canaries">
					<?php
						echo "<table border='1' cellpadding='1'>
							...
							<th>as_id</th>
							<th>user_id</th>
							<th>currentGoldValue</th>
							<th>currency</th>
							<th>lastTransAmt</th>
							<th>lastTransDate</th>
							</tr>";

						while($row = $Mysqli->getOne('account_summary'));
						{
							echo "<tr>";
							echo "<td>" . $row['as_id'] . "</td>";
							echo "<td>" . $row['user_id'] . "</td>";
							echo "<td>" . $row['currentGoldValue'] . "</td>";
							echo "<td>" . $row['currency'] . "</td>";
							echo "<td>" . $row['lastTransAmt'] . "</td>";
							echo "<td>" . $row['lastTransDate'] . "</td>";
							echo "</tr>";
						}
						echo "</table>";
					?>
				...
				<div class="edit_kong">
					<a href="/admin_database/database"><div style="float:left; margin-right:50px;" id="transactBar">GO BACK</div></a>
					<a href="/admin_database/view_account_summary_addnew"><div style="float:left; margin-right:50px;" id="transactBar">ADD</div></a>
					<a href="/admin_database/view_account_summary_edit"><div style="float:left; margin-right:50px;" id="transactBar">EDIT</div></a>
					<a href="/admin_database/view_account_summary_delete"><div style="float:left;" id="transactBar">DELETE</div></a>
				</div>
			</div>
