		...
		<div class="database_sidebar" id="myToggle">
			<nav class="nav_database">
				<ul>
					...
					<li><a href="/admin_database/view_members" class="current">VIEW MEMBERS</a></li>
		...
		<div class="database_content">
			...
			<div id="top_others_content_second">
				...
				<div class="profile_form">
					<form action="admin_view_members_delete_done.php" method="POST" name="RegisterForm" id="RegisterForm" enctype="multipart/form-data">
						<label>USER ID:</label>
						<input name="user_id" type="text" id="user_id" placeholder="user id" required />
						<br>
						<br>
				...
				<div class="edit_kong">
					<a href="/admin_database/view_members"><div style="text-align:center;" id="transactBar">GO BACK</div></a>
				</div>
			</div>
