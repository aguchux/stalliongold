	...
	<div class="database_container">
		<div class="database_sidebar" id="myToggle">
			<nav class="nav_database">
				<ul>
					...
					<li><a href="admin_view_members.php" class="current">VIEW MEMBERS</a></li>
		...
		<div class="database_content">
			...
			<div id="top_others_content_second">
				...
				<div class="edit_kong">
					<a href="admin_view_members.php"><div style="text-align:center;" id="transactBar">GO BACK</div></a>
				</div>
			</div>
