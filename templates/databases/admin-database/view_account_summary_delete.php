	...
	<div class="database_container">
		...
		<div class="database_content">
			...
			<div id="top_others_content_second">
				<div class="boxOne">
					<p>DELETE ACCOUNT SUMMARY OF CLIENTS</p>
				</div>
				...
				<div class="profile_form">
					<form action="admin_view_account_summary_delete_done.php" method="POST" name="RegisterForm" id="RegisterForm" enctype="multipart/form-data">
