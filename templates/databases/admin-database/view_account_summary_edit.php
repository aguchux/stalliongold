		...
		<div class="database_content">
			...
			<div id="top_others_content_second">
				...
				<div class="profile_form">
					<form action="admin_view_account_summary_edit_formid.php" method="POST" name="RegisterForm" id="RegisterForm" enctype="multipart/form-data">
						<label>ACCOUNT SUMMARY ID:</label>
						<input name="as_id" type="text" id="as_id" placeholder="account summary id" required />
						<br>
						<br>
						<input type="submit" name="submit" class="buttonsneh" value="ENTER" />
					</form>
				</div>
