	...
	<div class="database_container">
		...
		<div class="database_content">
			<div class="tandc">
				...
				<div class="boxTwo">
					<p>The personal secure online account enables each client to have easy access to all their gold assets and view the individual and collective valuations in the stipulated currency of the client's choice. These valuations are subject to terms and conditions of Titan Gold Resources, and all transactions on the gold assets and resources are contractually binding on either the client or the client's next of kin.</p>
					...
					<p>The annual management cost of the major gold assets on Titan Gold Resources online platform is 0.08%, which is over 5 times lower than the storage rate for gold on other Gold Bullion Vaults across the globe. Allocated storage at a bank would usually cost around 10 times our allocated storage rate.</p>
					<p>Titan Gold Resources Gold Investment Plan allows you to build gold savings with minimum effort. Set up a monthly payment or standing order with your bank to make regular deposits into your secure online account and we’ll use the available funds to buy more gold assets at the Dubai Price, the global benchmark used in the professional wholesale markets and published daily on the Asian Bullion Market website.</p>
